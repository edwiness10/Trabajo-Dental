...
call sicar.registroArti('B111111','Pruebaprueba2','esto es una prueba Smith generada auto',1,150,30,1,'DDV890119HC9','ip');
call sicar.registroArti('B34511','Pruebaprueba2','esto es una prueba Smith generada auto',1,130,30,1,'DDV890119HC9','ip');
call sicar.registroArti('AB-205425','Pruebaprueba2','esto es una prueba Smith generada auto',1,12000,30,1,'DDV890119HC9','ip');
call sicar.registroArti('AB-236075','Pruebaprueba2','esto es una prueba Smith generada auto',1,100,30,1,'DDV890119HC9','ip');
call sicar.registroArti('AB-2075','Pruebaprueba2','esto es una prueba Smith generada auto',1,10000,150,1,'DDV890119HC9','ip');
...
ALTER TABLE  sicar.registros_aut add sicar.registros_aut.ipuser varchar(100);
...
SELECT  CURDATE()INTO fecha_v ;                        -- alta de fecha
